...
最高。自动分支以 ±0.5 FPS 容差识别 60/90/120/144/180/240/360 等专用帧率族，
...
| 60 | 源帧率 ×4，即 240 FPS | 居中 5 抽头 Vegas，amount 1.0 |
| 90 | 源帧率 ×3，即 270 FPS | 居中 5 抽头 Vegas，amount 1.0 |
| 120 | 源帧率 ×2，即 240 FPS | 居中 3 抽头 Vegas，amount 0.85 |
| 144 | 源帧率 ×2，即 288 FPS | 居中 5 抽头 Vegas，amount 0.925 |
| 180 | 固定 360 FPS | 5→7 抽头连续混合，amount 0.925 |
| 240 | 保持 240 FPS，跳过主 RIFE 补帧 | 居中 5 抽头 Vegas，amount 1.0 |
| 其他 56–`<240` | 精确补到 240 FPS | 居中策略，amount 1.0 |
| `>=240` | 保持输入时间轴，跳过主 RIFE 补帧 | 居中策略，amount 1.0 |

270→60 与 288→60 不是整数抽样间隔。Fast 版按精确输出时刻在相邻的已模糊帧
